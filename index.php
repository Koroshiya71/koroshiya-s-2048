...
<body>
	<div class="box">
		...
		<form action="check.php" method="post" enctype="multipart/form-data">
			<div class="inputBox">
				<input type="text" autocomplete="off" name="name" value="" required="required" placeholder="           请输入您的用户名" pattern="[a-zA-Z0-9_-]{4,16}" title="4到16位（字母，数字，下划线，减号）"><label>用户名</label>
			</div>
			<div class="inputBox">
